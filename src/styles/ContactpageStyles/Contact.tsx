...
export const FormBtnStyles = styled.button`
  ...
  display: flex;
  border-radius: 0.5rem;
  background: ${(props )=> props.disabled ? "hsla(271, 69%, 48%,0.7)": "var(--purple, #D4A64E)" };
  box-shadow: 0px 4px 8px 0px  #D4A64E;
  ...
  width: 100%;
  &:hover {
    background: var(--purple-600,  #D4A64E);
  }
`;
...
export const ContactPageBtnStyles = styled(FormBtnStyles)<IContactBtn>`
  background: ${(props) =>
    props.$submitted ? "hsla(271, 69%, 48%,0.7)" : "var(--purple, #D4A64E)"};
  gap: 0.5rem;
  ${(props) =>
    props.$submitted &&
    css`
