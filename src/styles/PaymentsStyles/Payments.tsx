...
export const StepStyles = styled.div<IStepStyle>`
  ...
  .circle {
    ...
    ${(props) =>
      props.$isDoneWithOne &&
      css`
        border: 3px solid var(--purple, #D4A64E);
      `}
  }
`;
...
export const PlanStyles = styled.div<IRadioBtnStyleProp>`
  ...
  ${(props) =>
    props.$isChecked &&
    css`
      box-shadow: 0px 0px 1px 2px var(--purple, #D4A64E);
    `}
  display: flex;
  justify-content: space-between;
  .a,
...
export const RadioBtnStyle = styled.div<IRadioBtnStyleProp>`
  ...
  ${(props) =>
    props.$isChecked &&
    css`
      border: 2px solid var(--purple, #D4A64E);
      span {
        border-radius: 50%;
...
export const LoaderStyle = styled.div<ILoaderStyle>`
  ...
  width: 10.03219rem;
  height: 10.03219rem;
  border: 0.8rem solid #D4A64E;
  border-bottom: 0.8rem solid #D4A64E;
